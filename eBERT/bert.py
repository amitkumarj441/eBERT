...
class BertConfig(object):
    def __init__(self, vocab_size, hidden_size=768, num_hidden_layers=12, num_attention_heads=12, intermediate_size=3072, hidden_act='gelu', hidden_dropout_prob=0.9, attention_dropout_prob=0.9, max_seq_length=512, type_vocab_size=16, initialize_range=0.02):
